...
<body>
<div>
    <a href="view/student/addStudentInfo.jsp" style="text-decoration:none;">
        <span style="color:#ff0000; font-size:22px">${stuDeleteErrorMessage}</span><br/>
    ...
    <script type="text/javascript">
        countDown(5, 'view/student/addStudentInfo.jsp');
    </script>
</div>
</body>
</html>