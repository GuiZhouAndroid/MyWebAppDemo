...
<%--		time--;--%>
<%--		if(time === 0){--%>
<%--			window.location.href = "view/student/addStudentInfo.jsp"--%>
<%--		}--%>
...
<body>
<div>
    <a href="view/student/showOneStuInfo.jsp" style="text-decoration:none;">
        <span style="color:#ff0000; font-size:22px">${stuUpdateSuccessMessage}</span><br/>
    ...
    <script type="text/javascript">
        countDown(5, 'view/student/showOneStuInfo.jsp');
    </script>
</div>
</body>
</html>