...
<body>
<div>
    <a href="view/student/queryStudentInfo.jsp" style="text-decoration:none;">
        <span style="color:#ff0000; font-size:22px">${stuDeleteSuccessMessage}</span><br/>
    ...
    <script type="text/javascript">
        countDown(5, 'view/student/queryStudentInfo.jsp');
    </script>
</div>
</body>
</html>