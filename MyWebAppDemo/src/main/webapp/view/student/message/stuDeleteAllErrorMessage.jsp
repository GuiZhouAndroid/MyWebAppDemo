...
<body>
<div>
    <a href="../showAllStuInfo.jsp" style="text-decoration:none;">
        <span style="color:#ff0000; font-size:22px">${stuDeleteAllErrorMessage}</span><br/>
    ...
    <script type="text/javascript">
        countDown(5, '../showAllStuInfo.jsp');
    </script>
</div>
</body>
</html>